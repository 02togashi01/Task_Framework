...
<form action="deleteConfirm" method="post">
  ...
  <c:forEach var="Userinfo" items="${UserinfoList}">
    ...
    <div>
      <label>名前</label><input type="text" name="name" value="${fn:escapeXml(Userinfo.usersName)}" readonly>
    </div>
    <div>
      <label>TEL</label><input type="text" name="tel" value="${fn:escapeXml(Userinfo.telephone)}" readonly>
    </div>
 </c:forEach>
  </fieldset>
  <div>
